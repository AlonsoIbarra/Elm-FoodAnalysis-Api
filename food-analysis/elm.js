...
var _rtfeldman$elm_workshop$Auth$app_key = '5917e4ccf1aaadb15da0a0711775d7d4';
var _rtfeldman$elm_workshop$Auth$app_id = 'b5830ec9';
var _rtfeldman$elm_workshop$Auth$url_api = 'https://api.edamam.com/api/nutrition-details';

var _rtfeldman$elm_workshop$ElmCss$primaryAccentColor = _rtfeldman$elm_css$Css$hex('ccffaa');
var _rtfeldman$elm_workshop$ElmCss$NavBar = {ctor: 'NavBar'};
var _rtfeldman$elm_workshop$ElmCss$Page = {ctor: 'Page'};
var _rtfeldman$elm_workshop$ElmCss$css = function (_p0) {
...
}(
	{
		...
		_1: {
			...
			_0: A2(
				...
				_rtfeldman$elm_workshop$ElmCss$Page,
				{
					ctor: '::',
			...
			_1: {
				...
				_0: A2(
					...
					_rtfeldman$elm_workshop$ElmCss$NavBar,
					{
						ctor: '::',
						_0: _rtfeldman$elm_css$Css$margin(_rtfeldman$elm_css$Css$zero),
						_1: {
										...
										_0: _rtfeldman$elm_css$Css_Elements$li(
											{
												...
												_1: {
													ctor: '::',
													_0: _rtfeldman$elm_css$Css$color(_rtfeldman$elm_workshop$ElmCss$primaryAccentColor),
													_1: {ctor: '[]'}
												}
											}),
										_1: {ctor: '[]'}
